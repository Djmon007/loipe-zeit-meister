...
import { Receipt, Upload, Camera, FileText, Loader2, Pencil, Trash2 } from 'lucide-react';
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={() => editingExpense && deleteExpense(editingExpense.id)}>Löschen</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </div>
